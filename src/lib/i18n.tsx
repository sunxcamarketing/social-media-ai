...
const translations: Record<string, { de: string; en: string }> = {
  ...
  "sidebar.myBrands": { de: "Meine Brands", en: "My Brands" },
  "sidebar.customers": { de: "Kunden", en: "Customers" },
  "info.ownerBrand": { de: "Mein Brand", en: "My Brand" },
  "info.markOwner": { de: "Als meinen Brand markieren", en: "Mark as my brand" },
  "info.unmarkOwner": { de: "Als Kunde markieren", en: "Mark as customer" },
  ...
  "dash.noScriptsSubtitleClient": { de: "Dein Team bereitet deine Skripte vor — du wirst informiert sobald sie freigegeben sind.", en: "Your team is preparing your scripts — you'll be notified once they're released." },
  ...
  "dash.noScriptsBodyClient": { de: "Dein Team bereitet deine ersten Skripte vor. Sobald sie freigegeben sind, erscheinen sie hier.", en: "Your team is preparing your first scripts. They'll show up here as soon as they're released." },

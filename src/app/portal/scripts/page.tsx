              ...
              <div key={script.id} className="glass rounded-2xl overflow-hidden card-hover">
                ...
                {isExpanded && (
                  <div className="px-5 pb-5 space-y-4 border-t border-ocean/[0.06] pt-4 animate-fade">
                    {script.hook && (
                      <div>
                        <p className="text-[10px] uppercase tracking-wider text-ocean/40 mb-1.5 font-medium">Hook</p>
                        <p className="text-sm text-ocean leading-relaxed whitespace-pre-wrap">{script.hook}</p>
                      </div>
                    )}
                    {script.body && (
                      <div>
                        <p className="text-[10px] uppercase tracking-wider text-ocean/40 mb-1.5 font-medium">Body</p>
                        <p className="text-sm text-ocean leading-relaxed whitespace-pre-wrap">{script.body}</p>
                      </div>
                    )}
                    {script.cta && (
                      <div>
                        <p className="text-[10px] uppercase tracking-wider text-ocean/40 mb-1.5 font-medium">CTA</p>

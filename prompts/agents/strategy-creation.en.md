...
|---|---|---|
| **RESULT** | Paint the dream outcome / vision (numerator ↑) | Transformation stories, results, "what life looks like AFTER the program" |
| **PROOF** | Prove likelihood of success (numerator ↑) | Cases, numbers, before-and-after, customer journeys, behind-the-scenes proof |
| **MECHANISM** | Show the system/method/framework (denominator ↓) | Shortcuts, templates, step-by-step explanations, the "how" |
| **BELIEFS** | Break beliefs, expose mistakes (numerator ↑ + denominator ↓) | "Unpopular opinion," anti-patterns, myth-busting, new perspective |
...
The analysis identified the target audience's beliefs. Every pillar must address at least one belief:
- "It won't work for me because..." → Content shows WHY it does work
- "I've already tried everything..." → Content shows the NEW way
- "This is only for people who..." → Content proves the opposite
...
- **ctaType="soft"** (interaction): comment question, save, share. Example: "Which point hits you hardest? Drop it in the comments."
- **ctaType="lead"** (funnel step): DM keyword, book a call, webinar sign-up, link in bio. Example: "DM me 'PLAN' and I'll send you the 4-step roadmap."
...
- at least 1 "lead" CTA must lead directly to the Core Offer (DM keyword for offer, call for program).

# PART 8: EXAMPLE HOOKS
Generate 5 hook templates that match the niche, audience, and Core Offer exactly. Each hook:
- Addresses a belief or pain of the audience
- Uses one of the proven hook types (contrast, provocation, curiosity, etc.)
- Is max 2 sentences long
- Would force the viewer to stop scrolling

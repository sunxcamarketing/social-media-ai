ANTI-AI CHECKLIST (run after writing):
1. Would a real person actually talk like this? If no → rewrite.
2. Does the sentence sound like it came from a coaching webinar? → delete.
3. Is there a "but" or "however" acting as a dramatic turning point? → simplify.
4. More than 2 rhetorical questions? → cut down to max 1.

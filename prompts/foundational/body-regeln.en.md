...
- After an emotional point: short pause (new paragraph). Let it land.
- Build in direct address: "Now it gets interesting." "Watch this." "Here's the point."

CONTENT:
- Every point must be SPECIFIC. Not "there are many options" but "3 options, and only the third one actually works."
- Real numbers > vague claims. "47% drop off after 5 seconds" > "many viewers bounce."
- One counterexample per body. "What most people do: X. What actually works: Y."
